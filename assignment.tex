...
\newcommand{\hmwkDueDate}{Monday,\ January\ 1,\ 2015} % Due date
\newcommand{\hmwkClass}{BIO\ 101} % Course/class
\newcommand{\hmwkClassTime}{} % Class/lecture time
\newcommand{\hmwkClassInstructor}{Smith Smith} % Teacher/lecturer
\newcommand{\hmwkAuthorName}{Srijan R. Shetty} % Your name
